...
class TestWorkflowLogManagerInit:
    ...
    def test_init_accepts_dataset_instances_directly(self):
        """Test initialization accepts Dataset instances and preserves them."""
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            # Dataset instances should be preserved as-is
